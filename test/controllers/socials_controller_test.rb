...
class SocialsControllerTest < ActionController::TestCase
  ...
  test "should create social" do
    assert_difference('Social.count') do
      post :create, social: { learning: @social.learning, repeat: @social.repeat, subject: @social.subject, topic: @social.topic, understood: @social.understood }
    end
  ...
  test "should update social" do
    patch :update, id: @social, social: { learning: @social.learning, repeat: @social.repeat, subject: @social.subject, topic: @social.topic, understood: @social.understood }
    assert_redirected_to social_path(assigns(:social))
  end
